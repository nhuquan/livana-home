...
final allProducts = [
  ...
  Product(
    id: '2',
    title: 'Focus Tracker',
    description: 'A focus tracker app.',
  ...
  Product(
    ...
    description: 'An engaged Buddhism app.',
  ...
  Product(
    id: '5',
    title: 'Daily Wisdom',
    description: 'A daily wisdom app.',
  ...
  Product(
    id: '6',
    title: 'Sound Ground',
    description: 'A sound ground app.',
  ...
  Product(
    id: '8',
    title: 'Star Hunter',
    description: 'A star hunter game.',
